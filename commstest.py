...
class mavThread(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            if self.conn.wait_heartbeat(timeout=0.5) != None and self.source_system in self.conn.sysid_state:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        threadMavlink.updateData([0,0,0], [0,0,0], timestamp, [0,0,0], [0,0,0])
